...
{
    internal class Gigaworm_Head : Gigworm
    {
        public override string Texture { get { return "Nocturn/NPCs/Enemies/Worms/Gigaworm_Head"; } }
    ...
    internal class Gigaworm_Body : Gigworm
    {
        public override string Texture { get { return "Nocturn/NPCs/Enemies/Worms/Gigaworm_Body"; } }
    ...
    internal class Gigaworm_Tail : Gigworm
    {
        public override string Texture { get { return "Nocturn/NPCs/Enemies/Worms/Gigaworm_Tail"; } }
    ...
    public abstract class Gigworm : Gigaworm
    {
        ...
        public override void Init()
        {
            minLength = 10;
            maxLength = 10;
            tailType = NPCType<Gigaworm_Tail>();
            bodyType = NPCType<Gigaworm_Body>();
            headType = NPCType<Gigaworm_Head>();
            speed = 30f;
            turnSpeed = 0.6f;
        }
    }
    ...
    public abstract class Gigaworm : ModNPC
    {
        /* ai[0] = follower
		 * ai[1] = following
