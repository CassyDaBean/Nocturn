...
namespace Nocturn.NPCs.Enemies.Worms
{
    internal class CrystalWorm_Head : Crystalworm
    {
        public override string Texture { get { return "Nocturn/NPCs/Enemies/Worms/CrystalWorm_Head"; } }
    ...
    internal class CrystalWorm_Body : Crystalworm
    {
        public override string Texture { get { return "Nocturn/NPCs/Enemies/Worms/CrystalWorm_Body"; } }
    ...
    internal class CrystalWorm_Tail : Crystalworm
    {
        public override string Texture { get { return "Nocturn/NPCs/Enemies/Worms/CrystalWorm_Tail"; } }
    ...
    public abstract class Crystalworm : CWorm
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Crystal Dasher");
        }
        ...
        public override void Init()
        {
            minLength = 7;
            maxLength = 7;
            tailType = NPCType<CrystalWorm_Tail>();
            bodyType = NPCType<CrystalWorm_Body>();
            headType = NPCType<CrystalWorm_Head>();
            speed = 50f;
            turnSpeed = 0.6f;
        }
    }
    ...
    public abstract class CWorm : ModNPC
    {
        /* ai[0] = follower
		 * ai[1] = following
