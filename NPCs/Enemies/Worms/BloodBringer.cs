...
{
    internal class BloodBringer_Head : BloodBringer
    {
        public override string Texture { get { return "Nocturn/NPCs/Enemies/Worms/BloodBringer_Head"; } }
    ...
    internal class BloodBringer_Body : BloodBringer
    {
        public override string Texture { get { return "Nocturn/NPCs/Enemies/Worms/BloodBringer_Body"; } }
    ...
    internal class BloodBringer_Tail : BloodBringer
    {
        public override string Texture { get { return "Nocturn/NPCs/Enemies/Worms/BloodBringer_Tail"; } }
    ...
    public abstract class BloodBringer : Worm
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Blood Bringer");
        }
        ...
        public override void Init()
        {
            minLength = 5;
            maxLength = 5;
            tailType = NPCType<BloodBringer_Tail>();
            bodyType = NPCType<BloodBringer_Body>();
            headType = NPCType<BloodBringer_Head>();
            speed = 40f;
            turnSpeed = 0.3f;
        }
    }
