...
namespace Nocturn.NPCs.Bosses.Aquafuros
{
    internal class AquafurosHead : Aquafuros
    {
    ...
    internal class AquafurosBody : Aquafuros
    {
        public override string Texture { get { return "Nocturn/NPCs/Bosses/Aquafuros/AquafurosBody"; } }
    ...
    internal class AquafurosTail : Aquafuros
    {
        public override string Texture { get { return "Nocturn/NPCs/Bosses/Aquafuros/AquafurosTail"; } }
    ...
    public abstract class Aquafuros : AquafurosWorm
    {
    ...
    public abstract class AquafurosWorm : ModNPC
    {
        /* ai[0] = follower
		 * ai[1] = following
           ...
           /* if (Main.player[npc.target].dead && npc.timeLeft > 300)
            ...
            if (npc.life < npc.lifeMax * .25)
            {
                Attacking += 1;
                    ...
                    if (Attacking == 1)
                    {
                        int n = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("Aquafuros"));
