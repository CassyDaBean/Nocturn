    ...
    public class EndurisHead : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if(spawnparts == 3)
            {
                for (int B = 0; B < 2; B++)
                {
                    int Jaw = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, NPCType<EndurisJaw>(), npc.whoAmI, 0, 2);
            ...
            //npc.position = new Vector2 (player.Center.X - 270, player.Center.Y - 700);
